...
namespace ministry_altars.Data
{
    ...
    public class postgresqlapisingleton
    {
        ...
        private string db_name = DBContract.DATABASE_NAME;//"ministry_altars_database";
        ...
        public bool createdatabase()
        {
            try
            {
                string _default_database_name = utilzsingleton.getInstance(_notificationmessageEventname).getappsettinggivenkey("postgresql_database", "ministry_altars_database");
        ...
        public responsedto create_tables(postgresqlconnectionstringdto _connectionstringdto)
        {
            ...
            try
            {
                ...
                //bool does_table_exist_in_db = checkiftableexists(CONNECTION_STRING, DBContract.buildings_entity_table.TABLE_NAME);

                //Create altars table 
                string SQL_CREATE_ALTARS_TABLE = " CREATE TABLE IF NOT EXISTS " + DBContract.altars_entity_table.TABLE_NAME + " (" +
                      DBContract.altars_entity_table.ID + " SERIAL PRIMARY KEY NOT NULL, " +
                ...
                string SQL_CREATE_PASTORS_TABLE = " CREATE TABLE IF NOT EXISTS " + DBContract.pastors_entity_table.TABLE_NAME + " (" +
                      DBContract.pastors_entity_table.ID + " SERIAL PRIMARY KEY NOT NULL, " +
        ...
        public responsedto checkconnectionasadmin(postgresqlconnectionstringdto _connectionstringdto)
        {
            ...
            try
            {
                ...
                {
                    _responsedto.isresponseresultsuccessful = true;
                    _responsedto.responsesuccessmessage = "connection to postgresql successfull. buildings count [ " + count + " ].";
                    return _responsedto;
                }
                else
                {
