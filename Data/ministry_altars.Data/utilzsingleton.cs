...
namespace ministry_altars.Data
{
    ...
    public sealed class utilzsingleton
    {
        ...
        public altar_dto build_altars_dto_given_datatable(DataTable dt, int _index)
        {
            altar_dto _dto = new altar_dto();
            _dto.id = Convert.ToInt64(dt.Rows[_index]["aid"]);
            _dto.name = Convert.ToString(dt.Rows[_index]["name"]);
            _dto.address = Convert.ToString(dt.Rows[_index]["address"]);
            _dto.country = Convert.ToString(dt.Rows[_index]["country"]);
            _dto.county = Convert.ToString(dt.Rows[_index]["county"]);
        ...
        public pastor_dto build_pastors_dto_given_datatable(DataTable dt, int _index)
        {
            ...
            _dto.id_no = Convert.ToString(dt.Rows[_index]["id_no"]);
            _dto.dob = Convert.ToString(dt.Rows[_index]["dob"]);
            ...
            _dto.type = Convert.ToString(dt.Rows[_index]["type"]);
            _dto.altar_id = Convert.ToString(dt.Rows[_index]["altar_id"]);
            _dto.status = Convert.ToString(dt.Rows[_index]["status"]);
            _dto.created_date = Convert.ToString(dt.Rows[_index]["created_date"]);
