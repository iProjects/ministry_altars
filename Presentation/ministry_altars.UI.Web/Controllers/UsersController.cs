        ...
        public ActionResult Login([Bind] user_dto user_model)
        {
            ...
            else
            {
                ...
                if (is_hash_equal)
                {
                    ...
                    return RedirectToAction("Index", "Altars");
                }
                else
                {
        ...
        public ActionResult Create([Bind] user_dto model)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    //bool _exists = businesslayerapisingleton.getInstance(_notificationmessageEventname).check_if_altar_exists(model.email);
                    ...
                    _lstresponse = businesslayerapisingleton.getInstance(_notificationmessageEventname).create_user_in_database(_dto);
