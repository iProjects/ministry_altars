...
namespace ministry_altars.Entities
{
    public static class DBContract
    {
        ...
        //altars table
        public static class altars_entity_table
        {
            public static String TABLE_NAME = "tbl_altars";
        ...
        //pastors table
        public static class pastors_entity_table
        {
            public static String TABLE_NAME = "tbl_pastors";
            //Columns of the table
            public static String ID = "id";
            public static String NAME = "name";
            ...
            public static String TYPE = "type";
            public static String ALTAR_ID = "altar_id";
            public static String STATUS = "status";
            public static String CREATED_DATE = "created_date";
